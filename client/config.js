  ...
  files: {
    javascripts: {
      ...
      order: {
        before: [
          'app/env.js',
          'vendor/'+ environment +'/socket.io.js',
          ...
          'vendor/'+ environment +'/orbit-common-local-storage.js',
    ...
    stylesheets: {
      joinTo: {
        ...
        'stylesheets/app.css': /^app\/stylesheets\/(app|components|elements|utilities)\.css$/,
      }
    },
    templates: {
      precompile: true,
      ...
      files: {
        javascripts: {
          ...
          order: {
            before: [
              'app/env.js',
              'vendor/'+ environment +'/socket.io.min.js',
              'vendor/'+ environment +'/jquery.min.js',
              'vendor/'+ environment +'/handlebars.min.js',
              'vendor/'+ environment +'/ember.js',

              'vendor/'+ environment +'/orbit.min.js',
              'vendor/'+ environment +'/orbit-common.min.js',
              'vendor/'+ environment +'/orbit-common-local-storage.min.js',
