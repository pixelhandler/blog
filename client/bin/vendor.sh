...
copy_file orbit-common-local-storag.js $src $DEV_DIR
copy_file orbit-common-local-storag.min.js $src $PROD_DIR

src=$BOWER_DIR"/socket.io-client/dist"
copy_file socket.io.js $src $DEV_DIR
copy_file socket.io.min.js $src $PROD_DIR
